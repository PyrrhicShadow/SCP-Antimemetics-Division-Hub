##########################################################
# "CASE COLOURLESS GREEN" by qntm, from the SCP Wiki. Source: https://scp-wiki.wikidot.com/case-colourless-green. Licensed under CC-BY-SA.
##########################################################
...
label green: 
    ...
    kim """No description, no acquisition report, no test log, no addenda? 
    ...
    kim """I don't like the idea of you routinely exposing yourself to a cognitohazard so dangerous that we can't even write the reason why we can't write it down down.
    
    Especially because it's impossible for us to recover any usable information this way. You're going to go in, be incommunicado for two hours and come out a smiling amnesiac. 
    
    What do we gain from that? It's just a breach risk."""

    """Wheeler hears every word of this and elects to ignore it all. 
    
    There's a vague shape of familiarity about the entry as written; there are a few word choices which reassure her, in an intangible way, that it was written by someone who knew what they were doing. 
    ...
    It's built as a slender vertical cylinder with a single opening. The entire thing rotates on its axis. 
    ...
    """Kim is left alone in the antechamber. He stares at the outer door for a worried moment. 
    
    He presses his ear to the door for a while, but hears nothing. Not even a faint tremble from the airlock mechanism."""
    ...
    The room's interior walls are made from milky white glass (bulletproof, knowing Hughes) and plastered with paperwork, taped and Blu-Tacked up in vaguely coherent masses. 
    
    Where there is no paperwork, people have drawn directly on the walls in marker pen. 
    ...
    Most of the entries are dated and signed, and most of the dates are weeks apart. 
    
    The conversations are panicked and fearful back-and-forths about dozens of SCPs, some of them antimemetic in nature but none of them obviously related to one another. 
    
    None of the notes mention SCP-3125.

    The only name Wheeler recognises is her own, which appears on one in ten or twenty of the notes. The notes seem authentic and the handwriting is hers. 
    
    But her notes also seem as desperate and uncertain in tone as everybody else's. This unnerves her.
    ...
    Still lost for a logical entry point to the data, Wheeler curses all of her predecessors. 
    
    Asynchronous research — whereby the research topic is forgotten entirely between iterations, and rediscovered over and over — is a perfectly standard practice in the Antimemetics Division, and her people ought to be better trained than this. 
    ...
    Not exhausted, not sick, not physically injured; she's seen herself that way before, in the mirror. 
    ...
    SCP-3125 pervades all of reality except for volumes which have been specifically shielded from its influence. 
    ...
    That's the raw data. Those manifestations are troublesome enough to deal with in their own right…"""

    """The Wheeler in the video casts around, picks up a bright green felt-tip pen and a blank piece of paper. 
    ...
    Those data points are points on SCP-3125's hull; those manifestations are the shadows it casts on our reality. 
    ...
    Seven years ago there were more than four hundred antimemetics research groups worldwide. Government agencies, military branches, private corporations, university projects. 
    
    Many of them were GOIs or subdivisions of GOIs. We were allied with most of them. 
    
    We were at the spearhead of an Antimemetics Coalition which spanned the whole globe and thousands upon thousands of people. 
    
    None of those groups still exist. The last one ceased to exist some time in the last seventy-two hours.

    Three years ago, Foundation Antimemetics was an organisation of more than four thousand people. Now it's ninety.

    There's no war. We've lost the war. It's over. This is the mopping-up operation. 
    
    The only reason we still exist at all is because we have better amnestic biochemistry than anybody else in the world. 
    
    Because that's all you can do when you see SCP-3125: run away and try to forget what you saw… seek oblivion in chemicals, or alcohol, or head trauma. 
    
    And even that can't work every time. It's circling in. We meet it over and over again and we don't realise it. 
    
    There's no way we can stop ourselves from rediscovering it! We're too damned smart!"""

    """She points at something on the wall, out of view of the laptop's camera. Wheeler, watching, turns to look. 
    ...
    (But how'd the room get built in the first place? Anybody's guess.) 
    ...
    I think I blacked out for a moment, might have inhaled some. 
    ...
    Kim puts a hand on her shoulder and pushes her back down."""

    kim "You look terrible. There's something inl fleth your neck. Do you see that?" 
