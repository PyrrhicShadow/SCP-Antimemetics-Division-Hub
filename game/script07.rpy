...
label fresh: 
    ...
    "Wheeler goes on, finding himself unable to stop talking" 
    
    adam "Than being digitised by that thing, but not all that many."

    "Hutchinson glances in his direction, apparently paying him direct attention for the first time since they met, sixty crowded minutes ago." 
    
    marion "Riser cupboard."
    ...
    "The mass is almost on him. He's transfixed by its motion, its all-too-familiar grasping behaviour."

    marion "I figured." 
    
    "A hand descends, a human one with the conventional number of fingers." 
    ...
    "Hutchinson is already standing, and apparently not even significantly exerted." 
    
    marion "We need to get to the roof. I might be able to get a signal out from there."

    adam "You're at the gym pretty often? You train for fresh hell like this?"
    ...
    """Wheeler blinks a long blink, then focuses on something around the corner, something on the wall which Hutchinson can't see from where she's standing.""" 
    
    adam "Yeah. One second." 
    
    "He goes to it — it's a red panel — and pulls something down." 
    
    adam "Here, you were having no luck with the gun. Try this."
    ...
    "He says this to himself, over and over."

    marion "What was that word you used back there?"

    adam "Mmm?"

    "{i}Whunch.{/i}" 
    
    marion "Don't tune out. When the mass was coming down the hall. Did you say 'digitized'?"

    adam "…Um." 
    
    "Wheeler seems to change gear, and wake up." 
    
    adam "Yeah. Uh, but, in the old sense of the word—"

    marion "'Digit' meaning 'finger', so 'digitized' meaning 'turned into fingers'. I just got it." 
    
    """She's smiling, he can tell from the sound of her words. 
    ...
    marion "That piece is a nightmare."

    adam "It's a challenge." 

    marion "No, I mean it's chaotic. It's unlistenable."

    adam "I can play anything you like." 

    "Hutchinson appears to spend a moment considering this possibility."
    
    marion "Bach. You can play some Bach?"
