###########################################################
# "Unforgettable, That's What You Are" by qntm, from the SCP Wiki. Source: https://scp-wiki.wikidot.com/unforgettable-that-s-what-you-are. Licensed under CC-BY-SA.
##########################################################
...
label lake: 
    ...
    marness """After the war the second bomb collected dust for years. We began sketching improved designs for a third bomb, but around that time oversight was starting to flicker out. 
    
    We completed our research and production objectives, and were given no further objectives. Funding became shaky and we couldn't figure out why. 
    
    It wasn't entirely clear that the project overseers knew what we were doing. Or even that they remembered we existed. 
    
    It was a side-effect from the research, of course, one we had no way of managing at the time.

    In 1951, a cult movement began in Ojai, California. It was… wrong, everything about it was just wrong. 
    
    In a matter of days it was a national phenomenon and still growing. It was all over the news. To spread that far in months would have been credible, but days was simply impossible. 
    
    We, in the team, could see that the philosophy behind the cult was unnaturally contagious. It was the opposite of unthinkable, it was unforgettable. 
    
    We knew that this was what our bomb was designed for. We prompted the overseers for direction. But there were no orders.

    At the time that the outbreak began, we were a U.S. Army laboratory, through and through. Eight days into the crisis the Foundation 'acquired' us. 
    
    All the classified research, all the material resources, and all the compliant top staff, including me. Anybody who wouldn't comply was mind-wiped and sent back to the Army. 
    
    Twenty hours after the acquisition, we deployed the second bomb and the cult was gone. 
    
    Nobody remembered it, nobody remembered being part of it, zero loss of life. A completely clean detonation.

    After that is when everything really kicked off. Once we started working for the Foundation, the pace of research ramped up. 
    
    Every new technological advancement uncovered new hidden SCPs. I passed the Foundation field exams and went out catching ghosts. 
    
    My life turned into the Twilight Zone. I—"""

    "Marness blinks hard. He covers one of his eyes, then the other."

    marness """I remember all these different people now. It feels like my memory is in stereo. 
    
    Almost every antimemetic SCP we caught before the wipe in '76, we caught again soon after the wipe. 
    
    That means I remember two acquisition logs for each one. I remember two Antimemetics teams and I don't remember who belongs on which side of the wall. 
    
    Do you remember Goldie Yarrow? The neurologist? Studied the mechanism of anomalously accelerated memory loss… wrote a library on the subject…"""
    ...
    marness """There is an SCP which your division has never seen. The SCP which my division couldn't contain. The escapee. 
    ...
    "Marness locks eyes with her." 
    
    marness """It was eating my division alive. It came at us so hard and so fast that the only way we could stop it was to self-destruct. 
    
    But we had no site nuke, and in retrospect it is obvious to me, now, that this was because the SCP had consumed our site nuke first of all.

    If you know it exists, it knows you exist. The more you know about it, the more it knows about you. 
    
    If you can see it, it can see you. And you can see it. You've been looking right at it all afternoon."""

    "Wheeler is suddenly acutely aware of her surroundings."

    """There are only two of them on the boat. The boat is anchored more than a kilometre from any of the lake shores. 
    ...
    And a second boat. At minimum. Am I all alone out here? Why did I do that?"""
    ...
    There's an engineering lab in Site 41. You know it. 
    
    An underground complex the size of a football field. In pristine condition, and totally disused. Why? 
    ...
    Don't you get it? The whole division is looped! 
    
    We start the division, we run headlong into this thing, and either it eats us, or we wipe ourselves out in self-preservation. The idea of antimemes is as old as forgetfulness itself. 
    
    Humans have been looping through this problem over and over again since long before the Forties. Maybe for centuries!"""

    "His blindly probing fingers find the medical box. It's too late."

    """As Wheeler watches, a waving black pedipalp coated in dark hairs forces its way out through Marness' left eye. 
    ...
    scene cg spider lake

    """A second spider leg, significantly longer and spindlier, slides out through Marness' trachea, ruining his throat and voice box and producing a gout of blood. 
    
    He gurgles. A third leg shoots from his abdomen, like a spear. Wheeler shoots Marness in the head. 
    
    Marness falls forward, limp, then rises back up, lifted by the three spider appendages as if he is a puppet being controlled by something gigantic and invisible. 
    
    His arms raise, as if suspended by wires.

    Wheeler squints. She fires four more shots over Marness' head, at the likely body mass of the invisible puppeteer, and fires the rest of her clip almost directly into the sky. 
    
    The whole boat vibrates, along with the surface of the lake, as if responding to infrasound or a localised earthquake.""" 
    
    scene cg spider boat

    """Then the boat shudders violently and starts to lift out of the water, raised by more unseen appendages.

    Wheeler holsters her gun and goes for the medical box herself, pulling it away from Marness' floating feet. 
    
    There's a compartment with Class-B amnestic, the fast-acting stuff, in serum form. 
    
    She does a hurried burst of mental arithmetic, measures out the correct dosage in a syringe and, hands shaking, plunges it into a wrist vein. 
    
    The boat is still rising. Whatever the monster is, it's colossally tall, or maybe it flies.

    She is, of course, already dosed up to the eyeballs with mnestic drugs. Otherwise, she wouldn't have been able to perceive any of this. 
    
    Foundation medical literature warns in the strongest possible terms against putting both kinds of drug into the same brain. Best case scenario, this ends with her in the hospital."""

    """They're thirty metres up in the air now, ten storeys. There's a stabbing pain developing in her left eye. 
    
    She kicks her shoes off and throws the gun away. She goes to the edge and contemplates the drop for a disbelieving second. She jumps."""

    scene bg lake water

    """It takes two heart-stopping seconds of freefall for her to hit the water. The chilled hammerblow of the impact is enough to blank her mind out. 
    ...
    Only the symptoms of the drug cocktail give her any indication of what just happened: a sensation like hundreds of tiny lumps of hot solder in her brain, and pain and exhaustion spreading to all of her tendons. 
    ...
    They stabilise her in the helicopter, then take her to Site 41 for examination, and to have her system flushed.

    She spends a solid eight days at home, detoxifying: no mnestics, no amnestics, no exposure to dangerous memory-corrupting SCPs, no work visitors. 
    
    \"No work,\" the doctor also tells her, pointlessly.

    It isn't anywhere near the first missing event in Wheeler's life, nor is she the first person in the Antimemetics staff to have such an experience, but the sensation is no less disturbing for its familiarity. 
    
    As per procedure, she writes a report summarising everything she can remember. The gap in her memory is about thirteen hours.

    Then she adds her report to the extensive, complex map of Missing Time which the whole division maintains collectively. 
    
    It is a map of holes, and the map is becoming large enough that very faint patterns are gradually forming. The outline of an enemy is becoming visible, or perhaps a group of enemies.

    When she quizzes the extraction team later, none of them remember who activated the emergency beacon which summoned them. 
    
    In fact, the beacon itself cut out long before they landed at the lake. 
    
    Wheeler compares the current size of her division with her best estimate of what it should be. Maybe she needs a few more key people here and there… 
    
    So, assuming the division was fully staffed before the event, maybe those empty roles are the people who died this time around. Maybe one of them activated the beacon. 
    
    A commendable act, by someone now only known to exist because of that single act.
